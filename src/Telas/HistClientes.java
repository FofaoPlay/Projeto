 ...
 * @author Fofao
 */
public class HistClientes extends javax.swing.JFrame {

    /**
     * Creates new form HistClientes
     */
    public HistClientes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Tabela_Conta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Cliente", "Produto", "Valor Unit.", "Quantidade", "Total", "Data Compra", "Vencimento", "Tipo", "Status"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistClientes().setVisible(true);
            }
        });
    }
